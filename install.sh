...
update_paymenter() {
  ...
  printf '%b' "Continue with the latest Paymenter update? [y/N]: "
...
show_menu() {
  ...
  case "$MENU_CHOICE" in
    1)
      printf '%b\n' "${C3}Starting Paymenter installation...${NC}"
      if install; then
      ...
      ;;
    2)
      printf '%b\n' "${C3}Starting Paymenter uninstallation...${NC}"
      if uninstall; then
      ...
      ;;
    3)
      printf '%b\n' "${C3}Starting User/Admin account creation...${NC}"
      ...
      ;;
    4)
      printf '%b\n' "${C3}Starting Paymenter update...${NC}"
