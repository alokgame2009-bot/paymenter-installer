# Paymenter One-Command Installer
...
The installer deliberately runs Paymenter's `app:init` and `app:user:create` interactively instead of guessing their prompts. This is safer across Paymenter updates.
